...
namespace EPIC.Api.Migrations
{
    ...
    [Migration("20260907221454_AddChurchCommunity")]
    partial class AddChurchCommunity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EPIC.Api.Models.Announcement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("PushQueuedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EPIC.Api.Models.BlogPost", b =>
                {
            ...
            modelBuilder.Entity("EPIC.Api.Models.ChatMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<long>("JoinedAfterMessageId")
            ...
            modelBuilder.Entity("EPIC.Api.Models.ChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("RoomId", "SenderUserId", "ClientMessageId")
                        .IsUnique();

                    b.ToTable("ChatMessages");
                });

            modelBuilder.Entity("EPIC.Api.Models.ChatRoom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CustomerId", "Category", "Name")
                        .IsUnique();
            ...
            modelBuilder.Entity("EPIC.Api.Models.CommunityBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemberId", "BlockedMemberId")
                        .IsUnique();

                    b.ToTable("CommunityBlocks");
                });

            modelBuilder.Entity("EPIC.Api.Models.CommunityContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemberId", "ClientRequestId")
                        .IsUnique();

                    b.HasIndex("CustomerId", "Kind", "Status", "Id");

                    b.ToTable("CommunityContent");
                });

            modelBuilder.Entity("EPIC.Api.Models.CommunityReaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPIC.Api.Models.CommunityReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContentId", "MemberId")
                        .IsUnique();

                    b.ToTable("CommunityReports");
                });

            modelBuilder.Entity("EPIC.Api.Models.CommunityReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPIC.Api.Models.Event", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "EventDate");
            ...
            modelBuilder.Entity("EPIC.Api.Models.EventAttendance", b =>
                {
            ...
            modelBuilder.Entity("EPIC.Api.Models.EventDepartment", b =>
                {
                    ...
                    b.HasIndex("EventId", "DepartmentName")
                        .IsUnique();
            ...
            modelBuilder.Entity("EPIC.Api.Models.EventRole", b =>
                {
                    ...
                    b.HasIndex("EventDepartmentId", "RoleName")
                        .IsUnique();
            ...
            modelBuilder.Entity("EPIC.Api.Models.Expense", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "ExpenseDate");

                    b.ToTable("Expenses");
                });

            modelBuilder.Entity("EPIC.Api.Models.FoodReservation", b =>
                {
                    b.Property<int>("FoodReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FoodReservationId"));
            ...
            modelBuilder.Entity("EPIC.Api.Models.Income", b =>
                {
                    ...
                    b.HasIndex("CustomerId", "IncomeDate");
            ...
            modelBuilder.Entity("EPIC.Api.Models.MemberNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("MemberId", "AnnouncementId")
                        .IsUnique()
            ...
            modelBuilder.Entity("EPIC.Api.Models.MemberQrIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MemberQrIdentities");
                });

            modelBuilder.Entity("EPIC.Api.Models.MemberReward", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MemberId", "SourceKey")
                        .IsUnique();

                    b.ToTable("MemberRewards");
                });

            modelBuilder.Entity("EPIC.Api.Models.MemberRewardHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("EPIC.Api.Models.Ministry", b =>
                {
                    ...
                    b.Property<string>("ServiceTypeMapping")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("EPIC.Api.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime?>("PaymentProofUploadedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EPIC.Api.Models.PushDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EPIC.Api.Models.PushDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EPIC.Api.Models.QrScanLog", b =>
                {
                    b.Property<int>("QrScanLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("QrScanLogId"));
