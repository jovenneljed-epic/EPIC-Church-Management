...
namespace EPIC.Api.Controllers
{
    ...
    await IsLessonUnlockedAsync(
        ...
        {
            return await (new AcademyController(_context) { ControllerContext = ControllerContext }).Start(lessonId);
        }
        ...
        {
            return await (new AcademyController(_context) { ControllerContext = ControllerContext }).Complete(lessonId);
        }
